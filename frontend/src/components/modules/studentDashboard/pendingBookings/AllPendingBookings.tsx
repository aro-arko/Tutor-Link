...
import { Calendar, User, CreditCard, DollarSign, Clock } from "lucide-react";
...
const AllPendingBookings = () => {
      ...
      try {
        ...
        if (res.success) {
          const pending = res.data
            .filter((b: TBooking) => b.approvalStatus === "pending")
            .sort(
  ...
  return (
    <div className="p-1 md:p-4 mx-auto">
      ...
      {bookings.length === 0 ? (
        <p className="text-gray-600 text-center">No pending bookings found.</p>
      ) : (
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0 md:space-x-4">
                ...
                <div className="flex items-start space-x-3 flex-1 min-w-0">
                  ...
                  <div>
                    ...
                    <p className="text-base font-semibold text-yellow-600 capitalize">
